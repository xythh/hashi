...
* Pitch notation is supported with the syntax WORD{DROP_LOCATION}<br>for example: べんきょう{0} will generate the html for べんきょう￣ as a heiban word.<br>
Special syntax {-} supports drops before a word<br>for example: ねん{-} gets rendered as a drop before ＼ねん.
